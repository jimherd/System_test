...
namespace System_test {
    class FPGA_Sys {
        ...
        //
        enum PWM_REG { PERIOD = 0, ON_TIME = 1, CONFIG = 2, STATUS = 3 };
        //
        // constants to define bits in PWM config register

        const UInt32 PWM_CONFIG_DEFAULT = 0x00;
        enum PWM { OFF = 0x0, ON = 0x1 };
        enum INT_H_BRIDGE { OFF = 0x0, ON = 0x10000 };
        enum EXT_H_BRIDGE { OFF = 0x0, ON = 0x20000 };
        enum MODE { PWM_CONTROL = 0x0, DIR_CONTROL = 0x40000 };
        ...
        enum INVERT { NONE = 0x0, INVERT_1 = 0x4000000, INVERT_2 = 0x8000000, INVERT_ALL = 0xC000000 };
